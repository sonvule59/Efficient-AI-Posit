 ...
 * exact accumulation. Uses a custom posit implementation for arithmetic and quire.
 *
 * Note: Simplified implementation for posit32 (es=2) only. Quire operations are
 * software-emulated with basic 512-bit arithmetic.
 */
 ...
 * Stored as unsigned integers for bit manipulation.
 */
 ...
 * - Implemented as 8 uint64_t (512 bits).
 */
typedef struct {
    uint64_t data[8];
} quire32;
...
/* Conversions
 * Convert between posit32 and IEEE 754 float/double.
 */
